...
function default_1(app, pool) {
    ...
    */
    app.post('/api/addVar', auth_api_js_1.isAdmin, (req, res) => {
    ...
    */
    app.post('/api/modifyVar', auth_api_js_1.isAdmin, (req, res) => {
    ...
    Err:    400
    */
    app.post('/api/removeVar', auth_api_js_1.isAdmin, (req, res) => {
    ...
    Err:    400
    */
    app.post('/api/getVars', auth_api_js_1.isAdmin, (req, res) => {
