...
function default_1(app, pool) {
    ...
    */
    app.post('/api/addField', auth_api_js_1.isAdmin, (req, res) => {
    ...
    */
    app.post('/api/modifyField', auth_api_js_1.isAdmin, (req, res) => {
    ...
    Err:    400
    */
    app.post('/api/getFields', auth_api_js_1.isAdmin, (req, res) => {
