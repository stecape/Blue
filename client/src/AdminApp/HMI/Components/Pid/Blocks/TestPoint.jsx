...
export default function TestPoint({
  ...
  const TriangleBarIcon = (
    <g>
      <polygon
        points="24,34 38,10 10,10"
        fill="none"
        stroke="var(--rmd-theme-primary)"
        strokeWidth="2"
      />
      <rect
        x="10"
  ...
  return (
    <g transform={`translate(${offsetX} ${offsetY})`}>
      ...
      <use
        ...
        className={
          onSetClick
            ? styles.blockGroup + ' ' + styles.clickable
            : styles.blockGroup
        }
        style={onSetClick ? { cursor: 'pointer' } : {}}
        onClick={onSetClick ? onSetClick : undefined}
      />
      <text
        x={x + textPosOffsetX}
        y={y + (height / 6) * 9 + textPosOffsetY}
