...
import { AppBarTitle, APP_BAR_OFFSET_CLASSNAME } from '@react-md/app-bar';
...
const appBar = (
  ...
  return (
    <LayoutAppBar theme="primary">
      ...
      {mqttConnected ? (
        <WifiTetheringFontIcon className="icon-black" />
      ) : (
        <SignalWifiOffFontIcon className="icon-black" />
      )}
      {dbConnected ? (
        <StayPrimaryPortraitFontIcon className="icon-black" />
      ) : (
        <PhonelinkEraseFontIcon className="icon-black" />
      )}
      {backendConnected ? (
        <CloudQueueFontIcon className="icon-black" />
      ) : (
        <CloudOffFontIcon className="icon-black" />
      )}
