...
function TypesList() {
  ...
  const { setUpsertType, initUpsertTypeContext } =
    useContext(UpsertTypeContext);
  ...
  return (
    <>
                  ...
                  <TableCell className={tableStyles.cell}>
                    ...
                    <Button
                      ...
                      onClick={() =>
                        ...
                        axios
                          .post(`${serverIp}/api/getFields`, { type: item.id })
                          .then((res) => {
                            console.log(res);
                            setUpsertType(
                              () => ({
                                ...
                                typesList: ctx.types.filter(
                                  (i) => !res.data.result.deps.includes(i.id),
                                ),
                              }),
                              setUpsertTypePopup((prevState) => ({
                                ...prevState,
                                visible: true,
                              })),
                            ); //as callback, tt shows the popup
                          })
                      }
                    >
                      <EditFontIcon />
      ...
      <DeleteTypePopup
        ...
        delType={() => {
          axios
            .post(`${serverIp}/api/removeType`, { id: deletePopup.id })
            .then((response) => {
