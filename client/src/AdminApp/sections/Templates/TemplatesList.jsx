...
function TemplatesList() {
  ...
  const [upsertTemplatePopup, setUpsertTemplatePopup] = useState({
    visible: false,
  });
  const { setUpsertTemplate, initUpsertTemplateContext } = useContext(
  ...
  return (
    <>
                        ...
                        axios
                          ...
                          .then((res) => {
                            setUpsertTemplate(
                              ...
                              setUpsertTemplatePopup((prevState) => ({
                                ...prevState,
                                visible: true,
                              })),
      ...
      <DeleteTemplatePopup
        ...
        delTemplate={() => {
          axios
            .post(`${serverIp}/api/removeTemplate`, { id: deletePopup.id })
            .then((response) => {
