...
function LogicStatesList() {
  ...
  const [modifyLogicStatePopup, setModifyLogicStatePopup] = useState({
    visible: false,
    id: 0,
    name: '',
    value: [],
  });
  const [createLogicStatePopup, setCreateLogicStatePopup] = useState({
    visible: false,
  });
  ...
  return (
    <>
      ...
      <Button
        ...
        onClick={() => setCreateLogicStatePopup({ visible: true })}
      >
        <AddFontIcon />
      </Button>
      ...
      <DeleteLogicStatePopup
        ...
        delLogicState={() => {
          axios
            .post(`${serverIp}/api/removeLogicState`, { id: deletePopup.id })
            .then((response) => {
      ...
      <UpsertLogicStatePopup
        ...
        upsertLogicState={(data) => {
          axios
            .post(`${serverIp}/api/modifyLogicState`, {
              ...data,
              id: modifyLogicStatePopup.id,
            })
            .then(
              setModifyLogicStatePopup((prevState) => ({
                ...prevState,
                visible: false,
                value: Array(8).fill(''),
              })),
